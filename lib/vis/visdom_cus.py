...
class VisTracking(VisBase):
    ...
    def draw_data(self):
        ...
        cv2.rectangle(disp_image, (10, 10), (25, 25), (0, 255, 0), -1)
        cv2.putText(disp_image, "GT", (30, 23), cv2.FONT_HERSHEY_SIMPLEX, 0.5,
                    (255, 255, 255), 1)

        cv2.rectangle(disp_image, (10, 35), (25, 50), (0, 0, 255), -1)
        cv2.putText(disp_image, "Pred", (30, 48), cv2.FONT_HERSHEY_SIMPLEX, 0.5,
                    (255, 255, 255), 1)
